...
router.get('/', (req, res) => {
    ...
    function render(users) {
        res.render('view/views/index', { users: users});
    }
});
...
router.post('/view', (req, res) => {
    ...
    db.query('SELECT * FROM users WHERE id='+`${req.body.id}`, function (err, results, fields) {
    ...
    function render(users) {
        res.render('user/views/view', {users:users });
    }
});
